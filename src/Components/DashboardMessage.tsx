...
const DashboardMessage = ({ name }) => {
  return (
    <div className="w-full">
      ...
      <div className="flex md:flex-row flex-col justify-between md:items-center w-full md:w-full">
        <div className="flex bg-primary text-white md:w-[60%] items-center justify-between rounded-xl shadow-md p-4 my-3 min-h-[300px] px-10">
          <div className="flex flex-col gap-5">
            <h4 className="font-semibold text-white text-lg tracking-wider">
              Ongoing Elections
            </h4>
            <h2 className="font-bold text-2xl w-[80%] leading-7 text-white">
        ...
        <MyCalendar className={'w-full h-full'} />
      </div>
    </div>
  );
};
